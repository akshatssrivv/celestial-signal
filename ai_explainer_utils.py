...
def format_bond_diagnostics(history_df):
    ...
    return {
        ...
        "Z_RESIDUAL_BUCKET": round(safe_get(latest_row, "Z_RESIDUAL_BUCKET"), 2),
        "Cluster_Deviation_Flipped": round(safe_get(latest_row, "Cluster_Deviation_Flipped"), 2),
        "Volatility": round(safe_get(latest_row, "Volatility"), 2),
        "Regression_Component": round(safe_get(latest_row, "Regression_Component"), 2),
        "Composite_1W_Change": round(safe_get(latest_row, "Composite_1W_Change"), 2),
        "COMPOSITE_SCORE_1W_AGO": round(safe_get(latest_row, "COMPOSITE_SCORE_1W_AGO"), 2),
        "Composite_1M_Change": round(safe_get(latest_row, "Composite_1M_Change"), 2),

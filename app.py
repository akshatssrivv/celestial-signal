...
LOCAL_ZIP = "ns_curves_20250309.zip"
...
def unzip_ns_curves(zip_path: str = LOCAL_ZIP, folder: str = LOCAL_FOLDER, force: bool = False) -> tuple[str, str]:
    ...
    zip_path = download_from_b2(file_key="ns_curves_0309.zip", local_path=zip_path, force=force)
...
with tab1:
    ...
    B2_BUCKET_FILE = "ns_curves_0309.zip"
    try:

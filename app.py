...
LOCAL_ZIP = "ns_curves_20251610.zip"
LOCAL_FOLDER = "ns_curves_1610"
...
def unzip_ns_curves(zip_path: str = LOCAL_ZIP, folder: str = LOCAL_FOLDER, force: bool = False) -> tuple[str, str]:
    ...
    zip_path = download_from_s3(file_key="ns_curves_1610.zip", local_path=zip_path, force=force)
...
with tab1:
    ...
    S3_BUCKET_FILE = "ns_curves_1610.zip"
